document.addEventListener("DOMContentLoaded", function(){
    console.log("DOM display employee information"); //remove later

    fetch("/admin_retrieve_employee_total_ei")
    .then(response =>{
        if (!response.ok){
    ...
    .catch(error =>{
        console.error('Error fetching /admin_retrieve_employee_total_ei:', error);
    });
});
